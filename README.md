...
make run ID=Node-A PORT=:8080                 # start seed node
make run ID=Node-B PORT=:8081 SEED=:8080      # start a peer
make cluster                                  # launch 4-node cluster in Terminal tabs
make node PORT=:8080                          # GET /status from a node
